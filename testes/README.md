...
Este `README.md` e o `MANIFESTO.md` são os documentos originais fornecidos
pelo professor, descrevendo a convenção dos casos de teste. Alguns arquivos
citados aqui (a pasta `casos-validos` inteira, `i06_...minic` e o caso
`i07`) não estavam presentes no pacote recebido e foram completados pelo
aluno para fechar a cobertura — ver detalhes na seção "Sobre os casos de
teste" do `README.md` na raiz do repositório.
